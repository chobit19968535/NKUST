...
ANN_Input = KL.Input((64,))
h = KL.Dense(units=32, activation='relu', name='HiddenLayer1')(ANN_Input)
h = KL.Dense(units=32, activation='relu', name='HiddenLayer2')(h)
...
#                                                               #
#################################################################
ANN_detector.compile(optimizer='adadelta', loss='mse')
